    ...
    <>
      <div data-theme={darkTheme ? "dark" : "light"}>
        <footer className="footer footer-center bg-neutral text-neutral-content p-10">
          <aside>
            <img
              src="https://images.unsplash.com/photo-1620194544222-8c956ca15f1d?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt=""
              className="w-24 h-24"
            />
